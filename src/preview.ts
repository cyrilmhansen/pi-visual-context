...
export async function openPreview(debugDirectory: string, platform = process.platform, launcher: Launcher = nativeLauncher): Promise<void> {
  const page = join(debugDirectory, "page-001.png");
  try {
